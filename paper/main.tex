...
The 2026 ``3-2-1'' proposal \citep{highley2026solvable5} approximates a uniform lottery within an adjustment for the play-in tournament. The league has not yet adopted it; whether it does or develops an alternative, the design discussion is open. \cola{}'s contribution is the multi-year-history dimension that 3-2-1 omits, and a family-level view that gives policymakers a continuum across the variants. The bounds in this paper formalize the manipulation-resistance properties any future mechanism would need to address.

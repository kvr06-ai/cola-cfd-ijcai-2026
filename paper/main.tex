...
The 2026 ``3-2-1'' proposal \citep{highley2026solvable5} approximates a uniform lottery within an adjustment for the play-in tournament. Its three-year re-evaluation provision is expected to reopen the design discussion in 2029. \cola{}'s contribution to that re-evaluation is the multi-year-history dimension that 3-2-1 omits, and a family-level view that gives policymakers a continuum across the variants. The bounds in this paper formalize the manipulation-resistance properties any future re-evaluation would need to address.

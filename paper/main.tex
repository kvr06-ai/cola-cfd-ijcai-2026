...
\paragraph{SP under \cola{}:} Section~\ref{sec:bound} addresses the pool-manipulation channel analytically under Classic \cola{}, and Lemma~\ref{lem:capped-bound} addresses the per-series channel under Capped \cola{}.
